...
?>
        ...
        <?php
                    include("conecta.php");
                    $comando = $pdo->prepare("SELECT * FROM noti ");
                    $resultado = $comando->execute();
                    ...
                    while ($linhas = $comando->fetch()) {
                        ...
                        $subti = $linhas["subti"];
                        $dados_imagem1 = $linhas["foto"];
                        $foto = base64_encode($dados_imagem1);
                        echo ("
        ...
        <div class=\"Subti\">$subti</div>
        <div class=\"foto\"><img src='data:image/jpeg;base64,$foto' width='320px'></div>
        </div> 
